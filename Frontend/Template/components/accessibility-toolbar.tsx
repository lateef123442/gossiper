  ...
  return (
    <>
      ...
      <Button
        ...
        className="fixed bottom-4 right-4 z-40 h-12 w-12 rounded-full bg-primary text-primary-foreground shadow-xl border-2 border-white/20 hover:bg-primary/90 hover:shadow-2xl focus:ring-2 focus:ring-primary focus:ring-offset-2 transition-all duration-200"
